...
import argparse
import csv
from voxels import evaluate_voxel_prediction
    ...
    for epoch in range(0, args.epoch):
        ...
        with torch.no_grad():
            ...
            for i, batch_voxels in enumerate(valid_loader):
                ...
                eval_ans = evaluate_voxel_prediction(net_out.cpu().numpy(), batch_voxels.cpu().numpy(), 0.5)
                valid_mean_iou += np.mean(eval_ans[1] / eval_ans[2])
